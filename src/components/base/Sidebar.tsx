...
function Sidebar() {
  ...
  return (
    <aside
      className={`fixed flex lg:hidden z-10 top-0 right-0 h-full w-full justify-center items-center sidebar-opacity transition-all duration-100 ease-linear ${
        $isSidebarOpen ? "scale-100 visible" : "scale-0 invisible"
      }`}
    >

import { Moon, Sun } from "@/resources/static/Icons";
import { useEffect, useRef } from "react";
import { toggleTheme, isLightMode } from "@/resources/stores/theme-store";
...
function ThemeToggle() {
  ...
  return (
    ...
    >
      <div
        className="bg-crust transition-transform duration-200 absolute w-1/2 h-full"
        ref={overlayContainer}
      ></div>

      <div className="z-30 pl-2 p-1 relative" ref={moonIconContainer}>
        <Moon />
      </div>
      <div className="z-30 p-1 pr-2 relative" ref={sunIconContainer}>
        <Sun />
      </div>
    </button>
  );
